google.maps.__gjsload__('map', function(_) {
    var lla = function(a) {
        ...
        rla = function(a, b) {
            return a.g.g(a.h +
                "/$rpc/google.internal.maps.mapsjs.v1.MapsJsInternalService/GetViewportInfo", b, {}, _.nja)
        },
        sla = function(a) {
        ...
        xla = function(a) {
            if (!a.g) return !1;
            let b = _.Rf(a.g.m, 4);
            _.dm(a.g) && (a = sv(a), a = !(!a || !_.Rf(a.m, 1)), b = b || a);
            return b
        },
        yla = function(a) {
            if (!a.g) return !1;
            let b = _.Rf(a.g.m, 10);
            _.dm(a.g) && (a = sv(a), a = !(!a || !_.Rf(a.m, 3)), b = b || a);
            return b
        },
        zla = function(a) {
            if (!a.g) return !1;
            let b = _.Rf(a.g.m, 9);
            _.dm(a.g) && (a = sv(a), a = !(!a || !_.Rf(a.m, 2)), b = b || a);
            return b
        },
        tv = function(a) {
            const b = _.B(a.m, 1),
        ...
        Ela = function(a, b, c, d) {
            ...
            _.J(b, "panto", function(f) {
                if (f instanceof _.Pg) {
                    ...
                    const h = a.getZoom(),
                        k = a.getProjection();
                    g && null != h && k ? (f = _.vn(f, k), g = _.vn(g,
                        k), d.Wc({
        ...
        Ila = function(a) {
            if (!a) return null;
            a = a.toLowerCase();
            return Gla.hasOwnProperty(a) ? Gla[a] : Hla.hasOwnProperty(a) ?
                Hla[a] : null
        },
        Jla = function(a) {
            a.g.xh(b => {
        ...
        Mla = function(a, b, c) {
            let d = null;
            if (b = Lla(b, c)) d = b;
            else if (a && (d = new _.So, _.Po(d, a.type), a.params))
                for (let e in a.params) b = _.Ro(d), _.No(b, e), (c = a.params[e]) && _.Oo(b, c);
            return d
        },
        ...
        Pla = function(a, b, c, d, e) {
            ...
            if (e) {
                ...
                if ((c = e.Jr) && !_.Sc(c)) {
                    h || (h = new _.So, _.Po(h, 26), f.push(h));
                    for (const [p,
                            q
                        ] of Object.entries(c)) c = _.Ro(h), _.No(c, p), _.Oo(c, q)
                }
                const n = e.stylers;
        ...
        Rla = function(a) {
            ...
            (b = a.G({
                ...
                na: c,
                xa: d
            })) ? (b = (new _.Rm(_.Bia(a.F, b))).Yh("x", b.la).Yh("y", b.na).Yh("z", g), 1 != e && b.Yh("w", a.D.size.ca / e), f && (e *= 2), 1 != e && b.Yh("scale", e), a.g.setUrl(b.toString()).then(a.C)) : a.g.setUrl("").then(a.C)
        },
        uv = function(a, b, c, d = {
            Fd: null
        }) {
        ...
        Xla = function(a, b) {
            return new vv(Wla(a), a.g, "number" === typeof b ? new _.tn(b) : a.o, "number" === typeof b ? 21 : 22, "Hybrid", "Show imagery with street names", _.vq.hybrid,
                "m@" + a.F, {
                    type: 68,
                    params: {
        ...
        ama = function(a, b, c = {}) {
            ...
            if ("hybrid" ==
                ...
                b = Xla(a);
                b.g = {};
                for (const e of d) b.g[e] = Xla(a, e)
            } else if ("satellite" == b) {
                b = Zla(a);
                b.g = {};
                for (const e of d) b.g[e] = Zla(a, e)
            } else b = "roadmap" == b && 1 < _.qk() && c.pu ? new vv(Vla(a), a.g, a.o, 22, "Map", "Show street map", _.vq.roadmap, "m@" + a.F, {
                type: 68,
                params: {
                    set: "Roadmap"
                }
            ...
            }, "terrain", a.D, a.h, a.C, void 0, a.j) : new vv($la(a, "roadmap"),
                a.g, a.o, 22, "Map", "Show street map", _.vq.roadmap, "m@" + a.F, {
                    type: 68,
                    params: {
                        set: "Roadmap"
                    }
        ...
        fma = function(a) {
            return new _.js([a.draggable, a.du, a.Il], _.Ql(dma, ema))
        },
        ...
        xv = function(a, b, c) {
            function d() {
                var k = a.__gm,
                    l = k.get("baseMapType");
                l && !l.Lh && (0 !== a.getTilt() && a.setTilt(0), 0 != a.getHeading() && a.setHeading(0));
                var m = xv.Fu(a.getDiv());
                m.width -= e;
                ...
                m.height =
                    Math.max(1, m.height);
                l = a.getProjection();
                const n = xv.Gu(l, b, m, a.get("isFractionalZoomEnabled"));
                var p = xv.Nu(b, l);
                if (_.rg(n) && p) {
                    ...
                    q = a.getCenter();
                    k.get("isInitialized") && p && q && n && n === a.getZoom() ? (k = _.qm(m, _.vn(q, l)), l = _.qm(m, _.vn(p, l)), a.panBy(l.ca - k.ca, l.fa - k.fa)) : (a.setCenter(p), a.setZoom(n))
                }
            }
            let e = 80,
                f = 80,
        ...
        kma = function(a) {
            const b = a.g.length;
            for (let c = 0; c < b; ++c) _.Co(a.g[c], yv(a, a.mapTypes.getAt(c)))
        },
        nma = function(a, b) {
        ...
        lma = function(a, b) {
            if (b) {
                ...
                b instanceof _.ik && (c = "Ots", d = 150782);
                a.C(c, d)
            }
        },
        mma = function(a, b) {
        ...
        Av = function(a) {
            ...
            switch (a) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    Av(2), c = 165755, b = "Rmmi"
            }
            c && b && (_.M(window, c), _.N(window, b))
        },
        Bv = function(a, b, c) {
            a.map.__gm.ka(new _.jka(b,
                c))
        },
        uma = function(a) {
            const b = a.map.__gm;
            ...
            _.Fd(g, "complete",
                () => {
                    if (_.Ge(g)) {
                        ...
                        [h] = _.dn(k.m, 1, _.oq);
                        k = _.gm(k.m, 2);
                        h && h.toArray().length ? Bv(a, h, k) : (console.error(f), Bv(a, null, null))
                    } else console.error(f), Bv(a, null, null);
                    b.G.then(() => {
        ...
        xma = function(a, b) {
            if (a.h = b) a.o && a.set("heading", a.o), b = a.get("mapTypeId"), a.gj(b)
        },
        yma = function(a) {
            ...
            if (a.get("mapTypeId")) {
                var b = a.set; {
                    ...
                    if (a.g) {
                        ...
                        var e = yma(c);
                        d = d > e ? e : d
                    } else d = zma(a), null == d ? d = null : (e = _.rg(f) && 22.5 < f, c = !_.rg(f) && 18 <= c, d = d && (e || c) ? 45 : 0)
                }
            ...
            if (!a.isEmpty()) {
                ...
                (f || g.length || h) && _.nn(b, "maptypeid_changed", () => {
                    ...
                    "roadmap" === b.get("mapTypeId") ? (c.set("apistyle",
                        ...
                        l = l.Id(m)
                    }), c.j.set(l), c.ig.set(h)) : (c.set("apistyle", null), c.set("hasCustomStyles", !1), g.forEach(m => {
                        l = l.jf(m)
                    }), c.j.set(l), c.ig.set(k))
                })
            }
        },
        Cma = function(a) {
            if (!a.C) {
                a.C = !0;
                var b = () => {
                    a.ha.El() ? _.Fo(b) : (a.C = !1, _.K(a.map, "idle"))
                };
                _.Fo(b)
            }
        },
        ...
        Ema = function(a, b) {
            try {
                b && b.forEach(c => {
                    c && c.featureType && Ila(c.featureType) && (_.N(a, c.featureType), c.featureType in Dma && _.M(a, Dma[c.featureType]))
                })
            } catch (c) {}
        },
        Hma = function(a) {
            ...
            for (const g of a) {
                ...
                if (e)
                    for (const k of e) {
                        a: {
                            for (const l in k)
                                if (d = k[l], (e = l && Gma[l.toLowerCase()] || null) && (_.rg(d) || _.ug(d) || _.vg(d)) && d) {
                                    d = "p." + e + ":" + d;
                                    break a
                                }
                            d = void 0
            ...
            b =
                b.join(",");
            return b.length > (_.qj[131] ? 12288 : 1E3) ? (_.yg("Custom style string for " + a.toString()), "") : b
        },
        ...
        Pma = function(a, b) {
            switch (_.C(b.m, 10)) {
                ...
                default:
                    ...
                    if (1 != c && 2 != c) return _.Qp(), b = _.Q(_.E(b.m,
                        9, _.xj).m, 3) ? _.H(_.E(b.m, 9, _.xj).m, 3) : _.iia(), _.yg(b), _.x.gm_authFailure && _.x.gm_authFailure(), _.sn(), _.ci(a.g), !1;
                    2 == c && a.W();
                    _.sn()
            }
            return !0
        ...
        Jv = function(a, b) {
            if (!a.j || a.j === b) {
                var c = b === a.h;
                const d = b.Xf();
                d && a.g.has(d) ? Hv(a, b, c) : (Iv(a, b, c), b = a.g.values().next().value, Hv(a, b, c))
            }
        },
        Kv = function(a, b) {
            if (b.targetElement) {
        ...
        Iv = function(a, b, c = !1) {
            b && b.targetElement && (b = b.Xf(), b.setAttribute("tabindex", "-1"), c && b.blur(), a.j = null, a.h = null)
        },
        Lv = function(a) {
            this.g = a
        },
        Rma = function(a, b) {
            ...
            for (const e of d) c.C.has(e) || c.C.set(e, new _.xfa({
                map: a,
                featureType: e
            }));
            c.Z = !0
        ...
        Nv = function(a, b) {
            ...
            a && (this.g = _.Gn(this.h).createElement("div"), this.g.style.width = "1px", this.g.style.height = "1px", _.Mn(this.g, 1E3));
            this.h = b;
            this.j && (_.jh(this.j), this.j = null);
            this.D && b && (this.j = _.nh(b, "mousemove", (0, _.la)(this.C, this), !0));
            this.title_changed()
        },
        Wma = function(a, b) {
            if (!_.hm(b)) {
                ...
                if (!1 !== c) {
                    ...
                    if ("none" !== c && ("cooperative" !== c || !d)) {
                        ...
                        if (!d && (0 < e && e < a.h || 0 > e && e > a.h)) a.h = e;
                            ...
                            d ? a.ha.os(f, b) : (c = Math.round(e.zoom + f), a.j !== c && (Vma(a.ha, c, b, () => {
                                a.j = null
                            }), a.j = c));
                            a.ke(1)
                        }
        ...
        bna = function(a, b, c, d = () => "greedy", {
            ...
            h = {
                ...
                wd({
                    ...
                    r && (r = 3 === q.button, n.enabled() && (q = n.h(4), "none" !== q && (r = n.ha.Ic().zoom + (r ? -1 : 1), n.g() || (r = Math.round(r)), p = "zoomaroundcenter" === q ? n.ha.Ic().center : n.ha.pd(p), Vma(n.ha, r, p), n.ke(1))))
                }
            };
            const l = _.to(b.Ze, h),
        ...
        Qv = function(a) {
            a.D || (a.D = !0, a.F(b => {
                ...
                if (a.instructions) {
                    ...
                    c && (0 === e && a.o ? hna(a.Ha, c, b, !1) : (a.Ha.Kb(c, b, d.ic), 1 !== e && 0 !== e || Qv(a)));
                    c && !d.ic && a.j(c)
                } else a.camera && hna(a.Ha, a.camera, b, !0);
                a.o = !1
            }))
        },
        ...
        Rv = function(a, b, c) {
            return {
                center: _.mm(c, _.Wi(_.Ui(b, a.tilt, a.heading), _.qm(_.Ui(a.zoom,
                    a.tilt, a.heading), _.nm(a.center, c)))),
                zoom: b,
                heading: a.heading,
                tilt: a.tilt
            }
        ...
        Vma = function(a, b, c, d = () => {}) {
            ...
            b = Math.min(b, e.max);
            b = Math.max(b, e.min);
            f && (b = Rv(f, b, c), d = a.j(a.g.getBoundingClientRect(!0), f, b, d), a.controller.h(d))
        },
        Sv = function(a, b) {
            const c = a.Ic();
            if (!c) return null;
        ...
        wna = function(a) {
            ...
            if (b) {
                ...
                _.J(b, "insert_at", c);
                c()
            } else _.qh(a, "embedreportoncelog_changed", function() {
                wna(a)
            })
        },
        xna = function(a) {
            ...
            if (b) {
                ...
                _.J(b, "insert_at", c);
                c()
            } else _.qh(a, "embedfeaturelog_changed", function() {
                xna(a)
            })
        },
        Tv = function() {},
        ...
        Cna = class {
            constructor(a, b, c, d, e, f, g, h) {
                ...
                this.o = !1;
                h && (a = this.pb(), Qla(a, f.size.ca, f.size.fa));
                Rla(this)
            }
            pb() {
                return this.g.pb()
    ...
    var Kna = class {
        ...
        g(a) {
            clearTimeout(this.h);
            1 == a ? (bma(this, !0), this.h = setTimeout(() => {
                cma(this)
            }, 1500)) : 2 == a ? bma(this, !1) : 3 == a ? cma(this) : 4 == a && (this.da.style.transitionDuration = "0.2s", this.da.style.opacity = 0)
        }
    };
    var ema = () => {
    ...
    var Lna = class {
        constructor(a, b, c, d) {
            ...
            _.to(c.hg, {
                ...
                Mg: e => {
                    this.o.El() || (this.j = e, 5 < Date.now() - this.C && gma(this))
                },
                Mc: e => {
                ...
                zg: {
                    Ee: (e, f) => {
                        this.h || (this.h = !0, wv(this, "dragstart", e.hb, f.Ea))
                    },
                    Ff: (e, f) => {
                    ...
                    ff: (e, f) => {
                        this.h && (this.h = !1, wv(this, "dragend", e, f.Ea))
                    }
                },
                Li: e => {
                    _.io(e);
    ...
    var ima = class {
        constructor(a, b, c, d, e, f) {
            ...
            _.J(c, "remove_at", h => {
                const k = this.g[h];
                k && (this.g.splice(h, 1), mma(this), k.clear())
            });
            _.J(c, "set_at", h => {
    ...
    var zv = class {
        ...
        Kn(a) {
            return this.h(this.g.Kn(a))
        }
        ln(a) {
            return this.h(this.g.ln(a))
        }
        Xc() {
            return this.g.Xc()
        }
    ...
    _.w.heading_changed = function() {
        if (!this.h) {
            ...
            if ("number" === typeof a) {
                ...
                a != b ? (this.set("heading", b), this.o = a) : (a = this.get("mapTypeId"), this.gj(a))
            }
        }
    };
    ...
    _.w.gj = function(a) {
        ...
        const d = this.get("tilt"),
            e = this.h;
        if (this.get("tilt") && !this.h && c && c instanceof vv && c.g && c.g[b]) c = c.g[b];
        else if (0 == d && 0 != b && !e) {
            this.set("heading", 0);
            return
        }
        c && c == this.H || (this.F && (_.jh(this.F), this.F = null), b = (0, _.la)(this.gj, this, a), a && (this.F = _.J(this.C, a.toLowerCase() + "_changed", b)), c && c instanceof _.ik ? (a = c.g, this.set("styles", c.get("styles")), this.set("baseMapType", this.C.get(a))) : (this.set("styles", null),
            this.set("baseMapType", c)), this.set("maxZoom", c && c.maxZoom), this.set("minZoom", c && c.minZoom), this.H = c)
    };
    _.w.Mt = function(a, b, c, d, e, f, g) {
        ...
        if (d instanceof vv) {
            ...
            if (b = this.j instanceof Mv)
                ...
                if (c = b.heading == a.heading && b.projection == a.projection && b.Xi == a.Xi) b = b.h.get(), c = a.h.get(), c = b == c ? !0 : b && c ? b.scale == c.scale && b.sf == c.sf && (b.zd == c.zd ? !0 : b.zd && c.zd ? b.zd.equals(c.zd) : !1) : !1;
                b = c
            } else b = !1;
    ...
    var Qna = class {
        ...
        moveCamera(a) {
            ...
            if ((b || a.center) && e && d) {
                ...
                2 === this.j ? (f = null != a.tilt ? a.tilt : f, g = null != a.heading ? a.heading : g) : 0 === this.j ? (this.h = a.tilt, this.g = a.heading) : (a.tilt || a.heading) && _.ch("google.maps.moveCamera() CameraOptions includes tilt or heading, which are not supported on raster maps");
                a = _.vn(e, d);
                b && b !== e && (b = _.vn(b, d), a = _.om(this.ha.dc, a, b));
                this.ha.Wc({
                    center: a,
                    zoom: c,
                    heading: g,
    ...
    var Tna = class extends _.L {
        changed(a) {
            if ("apistyle" != a && "hasCustomStyles" != a) {
                ...
                for (var c = _.tg(void 0, 0), d = _.tg(void 0, _.kg(b)); c < d; ++c) e.push(b[c]);
                d = this.get("uDS") ? "hybrid" == this.get("mapTypeId") ? "" : "p.s:-60|p.l:-60" : Hma(e);
                d != this.g && (this.g = d, this.notify("apistyle"));
                e.length && (!d || 1E3 < d.length) && _.ve(_.Ql(_.K,
    ...
    var Wna = class extends _.L {
        constructor(a, b, c, d, e, f, g, h, k) {
            ...
            this.Ba = new _.dj(() => {
                ...
                if (!l || _.jm(l).equals(_.im(l))) _.ci(this.g);
                else {
                    ...
                    var p = this.get("bounds"),
                        q = Fv(this);
                    _.rg(n) && p && q ? (n = q + "|" + n, 45 == this.get("tilt") && !this.j && (n += "|" + (this.get("heading") || 0))) : n = null;
                    if (n = this.D = n) {
                        if ((m = n != m) || (m = (m = this.get("bounds")) ?
                                this.C ? !this.C.tf(m) : !0 : !1), m) {
                            for (var r in this.h) this.h[r].set("featureRects", void 0);
                            ++this.F;
                            r = (0, _.la)(this.V, this, this.F, Fv(this));
                            n = this.get("bounds");
                            p = Oma(this);
                            n && _.rg(p) && (m = new Fna, _.z(m.m, 4, this.O), m.setZoom(Nma(this)), _.z(m.m, 5, p), p = 45 == this.get("tilt") && !this.j, _.z(m.m, 7, p), p = p && this.get("heading") || 0, _.z(m.m, 8, p), _.qj[43] ? _.z(m.m, 11, 78) : _.qj[35] && _.z(m.m, 11, 289), (p = this.get("baseMapType")) && p.Xi && this.o && _.z(m.m, 6, p.Xi), n = this.C = Dla(n, 1, 10), p = _.F(m.m, 1, _.yq), q = _.Yn(p), _.Vn(q, n.getSouthWest().lat()),
                                _.Wn(q, n.getSouthWest().lng()), p = _.Zn(p), _.Vn(p, n.getNorthEast().lat()), _.Wn(p, n.getNorthEast().lng()), this.G && this.H ? (this.H = !1, _.z(m.m, 12, 1), m.setUrl(this.Y.substring(0, 1024)), _.z(m.m, 14, this.G)) : _.z(m.m, 12, 2), Kma(this.X, m, r, this.g))
                        }
        ...
        changed(a) {
            "attributionText" !== a && ("baseMapType" === a && (Mma(this),
                this.D = null), _.ej(this.Ba))
        }
        V(a, b, c) {
            if (1 == _.C(c.m, 8) && (0 !== c.getStatus() && _.bi(this.g, 14), !Pma(this, c))) return;
            if (a == this.F) {
                if (Fv(this) == b) try {
                ...
                var e = {};
                for (let g = 0, h = _.B(c.m, 2); g < h; ++g) b = _.am(c.m, 2, Gna, g), a = _.H(b.m, 1), b = _.E(b.m, 2, _.yq), b = Lma(b), e[a] = e[a] || [], e[a].push(b);
    ...
    var Yna = class extends _.L {
        ...
        update() {
            ...
            b =
                new _.xja(this.get("minZoom") || 0, this.get("maxZoom") || 30);
        ...
        constructor(a) {
            ...
            this.O = d => {
                const e = d.currentTarget,
                    f = this.g.get(e);
                if (f.bf) "Escape" === d.key && f.Bl(d);
                else {
                    var g = !1,
                        h = null;
                    if (_.Tp(d) || _.Up(d)) 1 >= this.g.size ? h = null : (g = [...this.g.keys()], h = g.length, h = g[(g.indexOf(e) - 1 + h) % h]), g = !0;
                    else if (_.Vp(d) || _.Wp(d)) 1 >= this.g.size ?
                        h = null : (g = [...this.g.keys()], h = g[(g.indexOf(e) + 1) % g.length]), g = !0;
                    d.altKey && (_.Sp(d) || d.key === _.kka) ? f.yk(d) : !d.altKey && _.Sp(d) && (g = !0, f.Cl(d));
                    h && h !== e && (Iv(this, this.g.get(e), !0), Hv(this, this.g.get(h), !0), _.M(window, 171221), _.N(window, "Mkn"));
    ...
    Nv.prototype.F = function() {
        if (this.h) {
            ...
            if (this.g && this.o) {
                ...
                } else b = a.changedTouches ? a.changedTouches[0] : a, b = new _.Lm(b.clientX, b.clientY);
    ...
    var ana = class {
        ...
        Ff(a) {
            if (this.active) {
                a = this.active.Aw + (a.hb.clientY - this.active.origin.clientY) / 128;
                var {
                    center: b,
                    heading: c,
                    tilt: d
        ...
        ff() {
            this.cursor &&
                _.hq(this.cursor, !1);
            this.active && (this.active.Pe.release(), this.ke(1));
            this.active = null
        }
    };
    var $ma = class {
        ...
        Ee(a, b) {
            ...
            "none" === d || "cooperative" === d && c || (b.stop(), this.active ? this.active.Fe = Xma(this, a) : (this.cursor && _.hq(this.cursor, !0), (c = Sv(this.ha, () => {
                this.active = null;
                this.Rc.reset(b)
            })) ? this.active = {
                Fe: Xma(this, a),
        ...
        Ff(a) {
            if (this.active) {
                ...
                if ("none" !== b) {
                    var c = this.ha.Ic();
                    b = "zoomaroundcenter" ===
                        b && 1 < a.je ? c.center : _.nm(_.mm(c.center, this.active.Fe.hb), this.ha.pd(a.hb));
                    this.active.Pe.fi({
                        center: b,
        ...
        ff() {
            ...
            this.active && (this.active.Pe.release(), this.ke(4));
            this.active = null
        }
    };
    var boa = class {
        ...
        Ee(a, b) {
            ...
            if ("none" !== d && ("cooperative" !== d || !c))
                if (b.stop(), this.active) {
                    if (c = Pv(this, a), this.g = this.active.Fe = c, this.j = 0, this.h = a.rf, 2 === this.active.zh || 3 === this.active.zh) this.active.zh = 0
                } else this.cursor && _.hq(this.cursor, !0), (c = Sv(this.ha, () => {
                        this.active = null;
                        this.Rc.reset(b)
                    })) ?
                    (d = Pv(this, a), this.active = {
                        Fe: d,
                        Pe: c,
                        zh: 0
                    }, this.g = d, this.j = 0, this.h = a.rf) : this.Rc.reset(b)
        }
        Ff(a) {
            if (this.active) {
                var b = this.o(4);
                if ("none" !== b) {
                    var c = this.ha.Ic(),
                        d = this.h - a.rf;
                    179 <= Math.round(Math.abs(d)) && (this.h = this.h < a.rf ? this.h + 360 : this.h - 360, d = this.h - a.rf);
                    this.j += d;
                    ...
                    if (1 === e || 2 === e || 3 === e) d = e;
                        ...
                        if (e = this.C) 2 !== a.je ? e = !1 : (e = Math.abs(d.yh -
                            a.yh) || 1E-10, e = f >= ("cooperative" === b ? 10 : 5) && 50 <= a.yh && .9 <= f / e ? !0 : !1);
                        d = e ? 3 : this.D && ("cooperative" === b && 3 !== a.je || "greedy" === b && 2 !== a.je ? 0 : 15 <= Math.abs(d.hb.clientY - a.hb.clientY) && 20 >= f) ? 2 : 0
                    }
                    d !== this.active.zh && (this.active.zh = d, this.g = Pv(this, a), this.j = 0);
                    f = c.center;
                    e = c.zoom;
                    var g = c.heading,
                        h = c.tilt;
                    switch (d) {
                        ...
                        case 3:
                            ...
                            break;
                        case 1:
                            f = "zoomaroundcenter" === b && 1 < a.je ? c.center : _.nm(_.mm(c.center,
                                this.g.el), this.ha.pd(a.hb));
        ...
        ff() {
            this.o(3);
            this.cursor && _.hq(this.cursor, !1);
            this.active && (this.ke(this.active.zh), this.active.Pe.release(this.g ? this.g.el : void 0));
            this.g = this.active = null;
            this.j = this.h = 0
        }
    };
    var coa = class {
        ...
        Ee(a, b) {
            b.stop();
            if (this.active) this.active.Fe = cna(this, a);
            else {
                this.cursor && _.hq(this.cursor, !0);
                var c = Sv(this.ha, () => {
                    this.active = null;
        ...
        ff() {
            this.cursor && _.hq(this.cursor, !1);
            this.active && (this.active.Pe.release(), this.ke(5));
            this.active = null
        }
    };
    var doa = class {
    ...
    var foa = class {
        ...
        Wc(a, b) {
            a = this.g.Ti(a);
            this.camera && b ? this.h(this.G(this.Ha.getBoundingClientRect(!0), this.camera, a, () => {})) : this.h(ena(a))
        }
        C() {
        ...
        so(a) {
            this.g = a;
            !this.instructions && this.camera && (a = this.g.Ti(this.camera), a.center === this.camera.center &&
                a.zoom === this.camera.zoom && a.heading === this.camera.heading && a.tilt === this.camera.tilt || this.h(ena(a)))
        }
        Kj() {
            return this.g.Kj()
        }
    ...
    var kna = class {
        ...
        getBounds(a, {
            ...
            } else h = _.Ui(a.zoom, a.tilt, a.heading), f = _.mm(a.center, _.Wi(h, {
                ca: c,
                fa: g
        ...
        Po(a) {
            ...
            if (this.h) return a = this.h.Ud(a,
                this.g.center, _.rm(this.g.scale), this.g.scale.tilt, this.g.scale.heading, {
                    ca: b.width,
                    fa: b.height
                }), {
                clientX: b.left + a[0],
            ...
            const {
                ca: c,
                fa: d
            } = _.qm(this.g.scale, _.nm(a, this.g.center));
            return {
        ...
        Kb(a, b, c) {
            ...
            if ((f || this.h) && this.offset) this.origin = ola(e, _.mm(d, _.Wi(e, this.offset)));
            else if (this.offset = _.pm(_.qm(e,
                    _.nm(this.origin, d))), d = this.D) this.j.style[d] = this.o.style[d] = "translate(" + this.offset.ca + "px," + this.offset.fa + "px)", this.j.style.willChange = this.o.style.willChange = "transform";
    ...
    var ona = class {
            ...
            release(a) {
                ...
                if (!(0 >= this.h.length) && this.g) {
                    var c =
                        qla(this.h, e => 125 > b - e.rc && 10 <= this.g.rc - e.rc);
    ...
    var jna = class {
        ...
        os(a, b) {
            ...
            if (d = 0 === gna(this.controller) ? fna(this.controller) : this.Ic()) {
                ...
                a = Math.max(a, e.min);
                e = this.C();
                e && e.zoom === a || (b = Rv(d, a, b), c = this.j(this.g.getBoundingClientRect(!0), d, b, c), c.type = 0, this.controller.h(c))
            }
        }
        so(a) {
    ...
    Tv.prototype.g = function(a, b, c, d, e, f) {
        ...
        var k = new Promise(ja => {
                const Aa = _.nn(a, "bounds_changed", async () => {
                    ...
                    fb && !_.jm(fb).equals(_.im(fb)) && (Aa.remove(), await 0, h.set("mapHasBeenAbleToBeDrawn", !0), ja())
                })
            }),
            l = a.getDiv();
        if (l)
            if (42 !== Array.from(new Set([42]))[0]) _.nia(l);
            else {
                ...
                k.then(() => {
                    a.get("mapId") &&
                        (_.N(a, "MId"), _.M(a, 150505), a.get("mapId") === _.Aea && (_.N(a, "MDId"), _.M(a, 168942)))
                });
                ...
                u.bindTo("bounds", a);
                u.bindTo("zoom", a);
                l = new Ena(_.F(_.gg.m,
                    2, _.bq), _.fm(), _.gg.g(), a, t, r.obliques, f, h.g);
                ...
                var da = fma({
                    ...
                    Hb = ja => {
                        ...
                        ja || (sa && sa(), Oa || (Oa = !0, _.Rf(_.gg.m, 43) || G(null, !1), d && d.h && _.Fj(d.h), Xa && (Fa.He(Xa), Xa = null), _.bi(f, 0)), _.K(a, "tilesloaded"))
                    },
                    pc = new _.rs((ja, Aa) => {
                ...
                h.G.then(ja => {
                    a.get("webgl") && _.qj[15] || xla(ja) ? (_.N(a, "Wma"), _.M(a, 150152), _.ah("webgl").then(Aa => {
                        let fb, Rb = !1;
                        const Xb = ja.isEmpty() ? _.gm(_.gg.m,
                                41) : ja.o,
                            Pe = _.ai(185393),
                            Mb = () => {
                                _.N(a, "Wvtle");
                        ...
                        try {
                            ...
                            Rb ? (h.W(!1), _.yg("Attempted to load a Vector Map, but failed. Falling back to Raster. Please see https://developers.google.com/maps/documentation/javascript/webgl/support for more info")) : (_.bi(Pe, 0), h.W(!0), h.zb = fb, h.set("configVersion",
                                fb.J()), Fa.xo(fb.M()))
                        }
                    })) : h.W(!1)
                });
                ...
                Promise.all([h.o, h.G]).then(([ja, Aa]) => {
                    ...
                    ja = ja && (zla(Aa) || !1);
                    fb && (_.N(a, "Wte"), _.M(a, 150939));
                    ja && (_.N(a, "Wre"), _.M(a, 150938));
                    de.Hb.zg = new boa(Fa, wf, de, fb, ja, Qe, Av);
                    if (fb || ja) de.Hb.px = new coa(Fa, de, fb, ja, Qe, Av)
                });
                ...
                var wb = new _.is(a, Fa, function() {
                        ...
                        if (wb.C && wb.o && wb.g && wb.j && wb.h) {
                            ...
                            } else fb = _.qm(wb.g, _.nm(wb.C.min, wb.o)), Aa = _.qm(wb.g, _.nm(wb.C.max, wb.o)), fb = new _.O(fb.ca, fb.fa),
                ...
                d && (_.lm(d.j, function() {
                    const ja = d.j.get();
                    Xa || !ja || Oa || (Xa = new _.Cka(n, -1, ja, Fa.dc), d.h && _.Fj(d.h), Fa.Bb(Xa))
                ...
                h.o.then(ja => {
                    jd.j = ja ? 2 : 1;
                    if (void 0 !== jd.h || void 0 !== jd.g) jd.moveCamera({
                        tilt: jd.h,
                        heading: jd.g
                    }), jd.h = void 0, jd.g = void 0
                });
                var sd = new Yna(Fa, a);
                ...
                e = function() {
                    ...
                    ja ? (a.bindTo("svClient", ja, "client"), ja.__gm.bindTo("fontLoaded", Se)) : (a.unbind("svClient"), a.set("svClient", null))
                };
                e();
                _.J(a, "streetview_changed", e);
                a.g || (sa = function() {
                    sa = null;
                    Promise.all([_.ah("controls"),
                        h.o, h.G
                    ]).then(([ja, Aa, fb]) => {
                        const Rb = m.g,
                        ...
                        fb = Aa && (zla(fb) || !1);
                        ja.Fv(Xb, a, Y, Rb, u, r.report_map_issue, sd, Dc, m.hg, c, h.ud, t, Re, Fa, Aa, Pe, fb);
                        ja.Gv(a, m.h, Rb, Pe, fb);
                        ja.Do(c)
                    })
                }, _.N(a, "Mm"), _.M(a, 150182), rna(a, Y), sma(a));
                ...
                var ue = 0,
                    ...
                    $f = function() {
                        const ja = m.g.clientWidth,
                            Aa = m.g.clientHeight;
                        if (ue != ja || xg != Aa) ue = ja, xg = Aa, Fa && Fa.Yj(), p.set("size", new _.li(ja, Aa)), sd.update()
                    },
